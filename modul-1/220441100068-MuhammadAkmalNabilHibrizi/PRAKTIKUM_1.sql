...
ALTER TABLE pengeluaran CHANGE COLUMN Jenis_Tagihan Jenis VARCHAR(50) ;

ALTER TABLE pengeluaran MODIFY COLUMN ID_Pembayaran INT DEFAULT 0;
ALTER TABLE pengeluaran MODIFY COLUMN Jenis VARCHAR(10) DEFAULT 0;
ALTER TABLE pengeluaran MODIFY COLUMN total_harga INT DEFAULT 0;
ALTER TABLE pengeluaran MODIFY COLUMN Tanggal_Pembayaran DATE DEFAULT '2024-04-09';
...
INSERT INTO Mahasiswa VALUES (1,'Muhammad Akmal', 220441103,'Pertanian','lulus', 'Agrotekonologi');
INSERT INTO Mahasiswa VALUES (2,'Rayhanza Nadhif', 220441102,'teknik','lulus', 'Informatika');
INSERT INTO Mahasiswa VALUES (3,'Rifqi Khairan', 220441122,'teknik','lulus', 'Mesin');
INSERT INTO Mahasiswa VALUES (4,'Akmal Nabil', 220441133,'FEB','lulus', 'manajemen');
INSERT INTO Mahasiswa VALUES (5,'Anisyafaah', 220441144,'teknik','berhenti', 'Elektro');
INSERT INTO Mahasiswa VALUES (6,'Makin Amin', 220441155,'teknik','berhenti', 'Industri');
INSERT INTO Mahasiswa VALUES (7,'Nadhif AThala', 220441100,'teknik','berhenti', 'Informatika');
INSERT INTO Mahasiswa VALUES (8,'Syahrul Ramadhani', 220441166,'teknik','lulus', 'Industri');
INSERT INTO Mahasiswa VALUES (9,'Birrur Rijaal', 220441192,'teknik','berhenti', 'Informatika');
INSERT INTO Mahasiswa VALUES (10,'Rehan Ramadhan', 220441128,'teknik','lulus', 'Industri');

INSERT INTO Dosen VALUES (1,'Ahamd Rizal S.T., M.T', 220441138,'Teknik Informatika', 'Wakil Dekan 2');
...
INSERT INTO Dosen VALUES (10,'Abdullah S.Kom., M.Kom', 11223311441,'Sistem Informasi', 'Dekan');

-- UPDATE mahasiswa_status SET tanggal= '2022-02-03' where id_status=1;
-- DELETE FROM mahasiswa_status WHERE id_status=1;

INSERT INTO Pembayaran_UKT (ID_Pembayaran, nama, NIM, Semester, Tahun_Ajaran, Jumlah_UKT, Tanggal_Pembayaran )  VALUES (1, 'Muhammad Akmal', 22044000, 4, '2024/2025', 4000000, '2024-02-04');
...
INSERT INTO gaji_dosen VALUES (1,'Abdullah S.T., M.T', 220441128,'400000', '2024-02-07');
...
INSERT INTO gaji_dosen VALUES (7,'Muhammad Doni S.T., M.T', 220441166,'2000000', '2024-02-24');
INSERT INTO gaji_dosen VALUES (8,'Dwi Rinjani S.T., M.T', 220441192,'3000000', '2024-02-24');
INSERT INTO gaji_dosen VALUES (9,'Ahamd Rizal S.T., M.T', 220441128,'1500000', '2024-01-11');
INSERT INTO gaji_dosen VALUES (10,'Abdullah S.Kom., M.Kom', 1122331144,4000000, '2024-01-04');
  
INSERT INTO Laporan (id, Jenis, Deskripsi, tanggal)VALUES
(1,'Jumlah Dosen', 'terdapat 1002 dosen di Universitas Trunojoyo.', '2024-03-23'),
(2,'Jumlah Mahasiswa', '10005 mahasiswa aktif di Universitas Trunojoyo.', '2024-03-23'),
(3,'Laporan Pengeluaran Keuangan', 'Total pengeluaran keuangan Tahun in adalah Rp 120.000.000.', '2023-10-13'),
(4,'Jumlah Mahasiswa', 'Saat ini terdapat 8002 mahasiswa aktif di Universitas Trunojoyo.', '2022-06-22'),
(5,'Laporan Jumlah Dosen', 'Saat ini terdapat 1015 dosen di Universitas Trunojoyo.', '2022-06-22'),
(6,'Laporan Pengeluaran Keuangan', 'Total pengeluaran keuangan bulan ini adalah Rp 9.500.000.', '2022-05-10'),
(7,'Laporan Jumlah Mahasiswa', 'terdapat 20000 mahasiswa aktif di Universitas Trunojoyo.', '2025-09-08'),
(8,'Laporan Jumlah Dosen', 'Saat ini terdapat 1058 dosen di Universitas Trunojoyo.', '2023-09-08'),
(9,'Laporan Pengeluaran Keuangan', 'Total pengeluaran keuanglaporanan bulan ini adalah Rp 8.000.000.', '2023-12-12'),
(10,'Laporan Pengeluaran Keuangan', 'Total pengeluaran keuangan bulan ini adalah Rp 6.900.000.', '2024-02-12');

INSERT INTO krs (NAMA, NIM, Kode_Mata_Kuliah, Nama_Mata_Kuliah, SKS, Semester) VALUES
('MUHAMMAD AKMAL','220441100068', 'PEMBER5', 'Pemrograman Bergerak', 4, 4),
...
INSERT INTO Pengeluaran (ID_Pembayaran, Jenis_Tagihan,total_harga, Tanggal_Pembayaran) VALUES
(1, 'Biaya kebersihan',500000, '2024-03-01'),
(2, 'Biaya Tranportasi',100000, '2024-03-05'),
(3, 'Pengadaan Buku',300000, '2024-03-10'),
(4, 'Biaya Laboratorium',450000, '2024-03-15'),
(5, 'Biaya Listrik',600000, '2024-03-20'),
(6, 'Biaya Administrasi',870000, '2024-03-25'),
(7, 'Sewa Alat proyektor',900000, '2024-03-28'),
(8, 'Biaya Potong Rumput',900000, '2024-03-30'),
(9, 'Biaya Akomodasi',200000, '2024-04-02'),
(10, 'Biaya Kegiatan Ekstrakurikuler',300000, '2024-04-05');

select * from Laporan;
select Jenis_Tagihan, total_harga FROM BayarTagihan;

select * from BayarTagihan;
SELECT nama, status_mhs FROM mahasiswa_status;
select * from mahasiswa where nim=220441100;
-- DELETE FROM Laporan WHERE id=2;
UPDATE mahasiswa_status SET tanggal= '2022-03-03' where id_status=1;
-- ALTER TABLE Pembayaran_UKT MODIFY Semester INT(3);

SELECT COUNT(*) AS jumlah_mahasiswa FROM Mahasiswa;
SELECT COUNT(*) AS jumlah_dosen FROM Dosen;