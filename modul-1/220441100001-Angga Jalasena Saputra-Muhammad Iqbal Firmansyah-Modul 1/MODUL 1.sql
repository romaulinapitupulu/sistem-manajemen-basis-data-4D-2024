...
VALUES 
    (101, 'Angga', 'Teknik Informatika', 5, 'Aktif'),
    (102, 'Naela', 'Sistem Informasi', 4, 'Aktif'),
    (103, 'Imam', 'Sistem Informasi', 6, 'Aktif'),
    (104, 'Irfan faruq', 'Ilmu Komunikasi', 7, 'Aktif'),
    (105, 'Anies', 'Hukum', 5, 'Nonaktif'),
    (106, 'Tesa', 'Teknik Mesin', 8, 'Aktif'),
    (107, 'Roma', 'Kelautan', 3, 'Aktif'),
    (108, 'Sipak', 'Manajemen', 6, 'Nonaktif'),
    (109, 'Bintang', 'Teknik Industri', 5, 'Aktif'),
    (110, 'Dwik', 'Kelautan', 7, 'Aktif');
...
VALUES 
    ...
    (507, 'Kabel Proyektor', '2024-03-31', 3500000),
    (508, 'Kamera', '2024-04-01', 7000000),
    (509, 'Mikrofon', '2024-04-02', 4500000),
    (511, 'Papan Proyektor', '2024-04-03', 6000000);
...
DROP TABLE pembayaran_tagihan_rutin;
